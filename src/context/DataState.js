...
const DataState=(props)=> {
  ...
  //     CURD IN FARAJ SHEET
    const updateData=async(id,email,faraj)=>{
        const response=await fetch(`http://localhost:5000/api/datafaraj/updatedata/${id}`,{
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
...
//get data
    const getData=async()=>{
        ...
        const response=await fetch('http://localhost:5000/api/datafaraj/getdata',{
            method:'GET',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
    ...
    const deleteData=async(id,email,questions)=>{
        const response=await fetch(`http://localhost:5000/api/datafaraj/deletedata/${id}`,{
            method:'DELETE',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
  ...
  //     CURD IN 450 DSA
    const updateDataDSA=async(id,email,love,_Title,value)=>{
        const response=await fetch(`http://localhost:5000/api/dataDSA/updatedata/${id}`,{
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
...
//get data
    const getDataDSA=async()=>{
        ...
        const response=await fetch('http://localhost:5000/api/dataDSA/getdata',{
            method:'GET',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
    ...
    const deleteDataDSA=async(id,email,love,value)=>{
        const response=await fetch(`http://localhost:5000/api/dataDSA/deletedata/${id}`,{
            method:'DELETE',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
  ...
  //     CURD IN STRIVER SHEET
    const updateDataStriver=async(id,email,striver)=>{
        const response=await fetch(`http://localhost:5000/api/datastriver/updatedata/${id}`,{
            method:'POST',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
...
//get data
    const getDataStriver=async()=>{
        ...
        const response=await fetch('http://localhost:5000/api/datastriver/getdata',{
            method:'GET',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
    ...
    const deleteDataStriver=async(id,email,striver)=>{
        const response=await fetch(`http://localhost:5000/api/datastriver/deletedata/${id}`,{
            method:'DELETE',
            headers:{
                'Content-Type':'application/json',
                'auth-token': localStorage.getItem('token')
